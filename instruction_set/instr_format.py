"""
Nathanael Davidson CS211 2025-11-4
    ...
    def __str__(self): # type: ignore[override]
        ...
        for i in CondFlag:
            ...
            if masked and masked is i:
                bits.append(i.name) # type: ignore
        return "".join(bits)
...
class Instruction(object):
    ...
    def encode(self) -> int:
        ...
        return offset_field.insert(self.offset, 
                reg_src2_field.insert(self.reg_src2, 
                reg_src1_field.insert(self.reg_src1, 
                reg_target_field.insert(self.reg_target, 
                cond_field.insert(self.cond.value, 
                op_field.insert(self.op.value, 0))))))
...
def decode(word: int) -> Instruction:
        ...
        return Instruction(OpCode(op_field.extract(word)), 
